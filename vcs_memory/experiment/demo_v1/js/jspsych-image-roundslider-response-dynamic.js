/**
 * jspsych-image-roundslider-response
...
jsPsych.plugins['image-roundslider-response-dynamic'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.prompt !== null){
      //html += trial.prompt;
	  html += '<p style="position: relative; top: -360px;"' +trial.prompt+'</p>';
    }
    ...
    // add submit button
    html += '<button id="jspsych-image-slider-response-next" class="jspsych-btn" '+ (trial.require_movement ? "disabled" : "") + ' style="position: relative; top: -360px">'+trial.button_label+'</button>';
	...
	$("#slider").roundSlider(
		{
			...
			drag: function (args) {
				...
				document.getElementById("stimulus_id").src=image_name;
